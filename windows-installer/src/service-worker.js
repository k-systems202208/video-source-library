const CACHE_NAME='video-library-shell-v5';
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.startsWith('/api/')||url.pathname.startsWith('/video/')||url.pathname.startsWith('/subtitle/')||url.pathname.startsWith('/tmdb-image/')||url.pathname.startsWith('/tmdb-person-image/'))return;
