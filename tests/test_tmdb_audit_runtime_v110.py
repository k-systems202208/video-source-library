...
class TmdbRuntimeAuditTests(unittest.TestCase):
    def test_v3_marker_is_reassessed_and_reports_runtime_versions(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(row["appVersion"], "1.2.2")
